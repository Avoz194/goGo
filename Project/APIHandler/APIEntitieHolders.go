...
import (
	entities2 "github.com/Avoz194/goGo/Project/Entities"
)
...
func taskToHolder(task entities2.Task) TaskHolder {
...
func tasksToHolders(tasks []entities2.Task) []TaskHolder {
	holders:= []TaskHolder{}
...
func personToHolder(person entities2.Person) PersonHolder {
...
func personsToHolders(persons []entities2.Person) []PersonHolder {
